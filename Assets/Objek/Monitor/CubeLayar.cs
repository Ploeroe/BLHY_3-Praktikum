...
public class CubeLayar : MonoBehaviour
{
    [SerializeField]
    public Material CubeLayarMaterial;
   ...
   void Start()
    ...
    CubeLayarTexture = Resources.Load<Texture>("Textures/Carpet");
    ...
    GetComponent<MeshRenderer>().material = CubeLayarMaterial;
    }
}
...
public class CubeNeckMonitor : MonoBehaviour
{
    [SerializeField]
    public Material CubeNeckMonitorMaterial;
    ...
    Texture CubeNeckMonitorTexture;
   ...
   void Start()
    ...
    GetComponent<MeshRenderer>().material = CubeNeckMonitorMaterial;
    }
}
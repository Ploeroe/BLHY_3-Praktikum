...
public class CubePanggung : MonoBehaviour
{
// Declare Material to be reconized in the Inspector
    [SerializeField]
    public Material PanggungMaterial;
    ...
    void Start()
    {
        ...
        PanggungTexture = Resources.Load<Texture>("Textures/Carpet");
        ...
        GetComponent<MeshRenderer>().material = PanggungMaterial;
    }
}

...
// Declare Material to be reconized in the Inspector
    ...
    CubeTexture = Resources.Load<Texture>("Textures/Backdrop");
        ...
        uvs[16] = new Vector2(0.25f, 1.0f);
        uvs[17] = new Vector2(0.25f, 0.5f);
        ...
        uvs[20] = new Vector2(0.25f, 1.0f);
        uvs[21] = new Vector2(0.25f, 0.5f);
